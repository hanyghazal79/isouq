...
class _chatItemState extends State<chatItem> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: gradientAppBar(tr('chatting'),),
    ...
    return Center(
      ...
      child: ListView(
        children: <Widget>[
          ...
          Center(child: Text( tr('notHaveMessage'), style: TextStyle( fontWeight: FontWeight.w300,color: Colors.black12,fontSize: 17.0,fontFamily: "Popins"),))
        ],
      ),
    ));
  }
