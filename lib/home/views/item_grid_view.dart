        ...
        child: InkWell(
          onTap: () {
            ...
            Navigator.of(context).push(PageRouteBuilder(
                pageBuilder: (_, __, ___) => new ItemDetails(item: itemSale,),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text((itemSale.price != null && itemSale.price.isNotEmpty) ? "${itemSale.price} EGP" : "${itemSale.newPrice} EGP",
                      style: TextStyle(
                          fontSize: 12.0,
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      top: 4.0, left: 10.0, bottom: 15.0,right: 10),
                  child: Container(
                    height: 5.0,
                    width: 50,
